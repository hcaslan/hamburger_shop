...
{
    @ExceptionHandler(ShoppingServiceException.class)
    public ResponseEntity<ErrorMessage> handleDemoException(ShoppingServiceException ex){
        ErrorType errorType = ex.getErrorType();
        return new ResponseEntity(createErrorMessage(ex),errorType.getStatus());
    }

    private ErrorMessage createErrorMessage(ShoppingServiceException ex)
    {
