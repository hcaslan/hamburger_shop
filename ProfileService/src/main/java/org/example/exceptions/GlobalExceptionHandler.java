...
{
    @ExceptionHandler(ProfileMicroServiceException.class)
    public ResponseEntity<ErrorMessage> handleDemoException(ProfileMicroServiceException ex){
        ErrorType errorType = ex.getErrorType();
        return new ResponseEntity(createErrorMessage(ex),errorType.getStatus());
    }

    private ErrorMessage createErrorMessage(ProfileMicroServiceException ex)
    {
